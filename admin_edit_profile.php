...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$required_hours = isset($_POST["work_hrs"]) ? $_POST["work_hrs"] : "";
	...
	$sql = "INSERT INTO emp_info (name, address, age, gender, position, department, start_date, school, work_hrs) VALUES ('$fullname', '$address', '$age', '$gender', '$position', '$department', '$startdate', '$school', '$required_hours')";
...
<head>
    ...
    <title>AMS | Admin Edit Profile</title>
    <script>
