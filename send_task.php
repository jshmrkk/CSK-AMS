...
<head>
	...
	<!-- My CSS -->
    <link rel="stylesheet" href="css/send_task.css">
    ...
    <main>
        ...
        <div>
            ...
            <div class="input-form">
                <form class="filter" action="send_task.php" method="POST" >
                    ...
                    if(!isset($_POST['search'])){
                        ...
                        if(mysqli_num_rows($data)>0){
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="add_task.php" method="POST" id="add-task-form">
                                        <!-- HIDDEN INPUTS -->
                                ...
                                <td><?php echo $date;?></td>
                                <td>
                                    <input type="submit" class="btn" value="Send" form="add-task-form">
                                </td>
                            </tr>
                            <?php
                            }
        ...
        <div class="send-btn">
                    <input type="submit" class="search-filter" value="Send">
        </div>
    </main>
</section>
